...
The files are available in this [folder](https://drive.google.com/drive/folders/1QmEMm8R75f0HSfZdSJEnU2kwuuF08c57?usp=sharing). 
...
If you want to download the folder using the terminal you can do this by installing gdown (`pip install gdown`) and executing the following command: `gdown --folder https://drive.google.com/drive/folders/1QmEMm8R75f0HSfZdSJEnU2kwuuF08c57 --remaining-ok`
...
- Using the model to estimate water line flux ratios under different conditions: [Krijt et al. 2025](https://doi.org/10.3847/2041-8213/adfbe3)
