...
class complete_model:
    ...
    def read_data(self,variables={},dust_species={},absorp_species={},slab_dict={},R=0,wavelength_points=[],wavelength_points_full=[],ext_model=None,
        ...
        if not slab_only_mode:
            ...
            for key in self.abundance_dict:
                ...
                if q_files:
                    wavelength,kabs = np.loadtxt(dust_path+key_load,skiprows=1,usecols=(0,1),unpack=True)  

                else:
                    wavelength,kabs = np.loadtxt(dust_path+key_load, comments="#", skiprows=0,
    ...
    def set_surface(self,one_output=False,new_surface=True,small_window=False,timeit=False,absorption=False,comp='one'):
    ...
    def run_model(self,variables,dust_species,slab_dict,absorp_species=[],output_all=False,scaled_emission=True,timeit=False,debug=False):
        ...
        if output_all:
            if not self.slab_only_mode:
                ...
                if self.use_dust_emis:
                    if self.two_dust_comp:
                        self.set_surface(timeit=timeit,absorption=False,comp='hot')
                        self.set_surface(timeit=timeit,absorption=False,comp='cold')
               
                    else:
                        self.set_surface(timeit=timeit,absorption=False)
                if self.use_dust_absorp:
                    if self.two_dust_comp_abs:
                        self.set_surface(timeit=timeit,absorption=True,comp='hot')
                        self.set_surface(timeit=timeit,absorption=True,comp='cold')
            ...
            if not self.slab_only_mode:
                ...
                if self.use_dust_emis:
                    if self.two_dust_comp:
                        surface_flux=self.set_surface(timeit=timeit,absorption=False,one_output=True,comp='hot')
                        surface_flux+=self.set_surface(timeit=timeit,absorption=False,one_output=True,comp='cold')
                    else:
                ...
                if self.use_dust_absorp:
                    if self.two_dust_comp_abs:
                        absorption_flux=self.set_surface(timeit=timeit,one_output=True,absorption=True,comp='hot')
                        absorption_flux+=self.set_surface(timeit=timeit,one_output=True,absorption=True,comp='cold')
                    else:
    ...
    def water_line_diagnostics(self,mol_name='H2O',integrated=True, ratios=True,plot=True,printing=True,debug=False):
        '''
        ...
        Workflow:
            ...
            Calculating the ratios used by Banzatti+25 (if ratios=True)
        ...
        #dictionary with the wavelengths for all selected lines and their wavelength windows


        dict_water_unblended={5.34529: [5.343, 5.3475],
            5.63179: [5.629, 5.6347],
            5.64107: [5.6383, 5.6433],
            6.07545: [6.0726, 6.078],
            6.14316: [6.1402, 6.1455],
            6.1854: [6.1823, 6.1885],
            6.34443: [6.3416, 6.3474],
            6.43355: [6.4308, 6.4364],
            6.49224: [6.4889, 6.4953],
            6.52896: [6.526, 6.5318],
            6.97738: [6.9743, 6.9803],
            6.99328: [6.9907, 6.9954],
            7.14692: [7.1444, 7.1502],
            7.21253: [7.21, 7.2155],
            7.27924: [7.2759, 7.2819],
            7.30659: [7.3036, 7.3092],
            8.0696: [8.0645, 8.0741],
            9.90602: [9.9015, 9.9101],
            10.1132: [10.108, 10.118],
            10.76435: [10.758, 10.77],
            10.85307: [10.8482, 10.8594],
            11.00168: [10.9962, 11.0079],
            11.17771: [11.172, 11.1834],
            11.26877: [11.2625, 11.2763],
            11.64764: [11.6414, 11.6538],
            11.70161: [11.695, 11.707],
            11.96812: [11.9592, 11.9768],
            12.26544: [12.2573, 12.2719],
            12.5645: [12.5594, 12.569],
            12.89409: [12.8871, 12.9017],
            12.98575: [12.979, 12.9932],
            13.13243: [13.126, 13.1386],
            13.29319: [13.2864, 13.3005],
            13.31231: [13.3055, 13.3183],
            13.50312: [13.4969, 13.5116],
            14.34608: [14.34, 14.3546],
            14.42757: [14.4187, 14.4362],
            14.51301: [14.505, 14.5214],
            14.89513: [14.8888, 14.9038],
            15.62568: [15.6148, 15.6371],
            15.83495: [15.8273, 15.845],
            15.96622: [15.9561, 15.9736],
            16.27136: [16.2638, 16.2813],
            16.50525: [16.4943, 16.5161],
            16.54402: [16.535, 16.5521],
            16.59123: [16.5819, 16.5991],
            17.10254: [17.0917, 17.1121],
            17.14148: [17.1313, 17.1496],
            17.19352: [17.1856, 17.1999],
            17.32395: [17.316, 17.3338],
            17.35766: [17.35, 17.366],
            17.50436: [17.4962, 17.5149],
            17.56683: [17.5592, 17.5739],
            17.59626: [17.5851, 17.6062],
            18.25429: [18.2391, 18.268],
            19.12996: [19.1162, 19.1442],
            19.24597: [19.2355, 19.2573],
            19.34995: [19.3368, 19.365],
            19.68805: [19.6734, 19.7018],
            20.42595: [20.4128, 20.4397],
            20.66181: [20.6513, 20.6755],
            21.33317: [21.319, 21.3486],
            21.61495: [21.6021, 21.6305],
            21.7488: [21.7336, 21.7636],
            22.08091: [22.0648, 22.0969],
            22.13775: [22.1239, 22.152],
            22.37473: [22.3606, 22.389],
            22.99881: [22.981, 23.015],
            23.31846: [23.3049, 23.3296],
            23.81676: [23.802, 23.8313],
            23.89518: [23.8801, 23.9094],
            24.05845: [24.0445, 24.0713],
            24.41975: [24.4041, 24.4333],
            24.91403: [24.9039, 24.9254],
            25.14613: [25.1311, 25.1581],
            26.05384: [26.0396, 26.0718],
            26.25519: [26.242, 26.2688],
            26.64294: [26.63, 26.6576],
            26.72651: [26.7172, 26.7379],
            26.90847: [26.8938, 26.925],
            27.0272: [27.0105, 27.044]}
        ...
        if integrated:
            print('TODO')
            for centre in water_wavelengths:

                calc_fluxes.append(self.calc_integrated_flux('H2O',wave_lims=dict_water_unblended[centre],flux_input=modelled_flux,return_lum=False))
        else:
                    ...
                    for comb in combining_dict:
                        ...
                        for line in combining_dict[comb]['lines']:
                            if line<wave[1] and line>wave[0]:
                                if integrated:
                                    plt.axvspan(dict_water_unblended[line][0],dict_water_unblended[line][1],alpha=0.5,color='grey',linewidth=0.0)
                                if label_lines:
